      ...
      <div className="max-w-5xl mx-auto px-8 py-8">
        ...
        {trips.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center mb-8">
            <p className="text-gray-400 text-sm mb-4">No saved trips yet.</p>
            <Link
              href="/new-trip"
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm leading-relaxed">
                    Your AI concierge is ready to craft a deeply personalized
                    itinerary tailored to your unique tastes.
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Get personalized recommendations based on your travel style.",
                },
                {
                  title: "Smart Itineraries",
                  desc: "Your AI concierge optimizes time and budget automatically.",
                },
                {
                  title: "Curated Experiences",
                  desc: "Discover hidden gems tailored to your interests.",
                },
              ].map((item) => (
